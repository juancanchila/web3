...
class WebformEntityView extends WebformMarkupBase {
  ...
  public function prepare(array &$element, WebformSubmissionInterface $webform_submission = NULL) {
    try {
      ...
      if ($entity = $this->entityTypeManager->getStorage($element['#target_type'])->load($element['#selected_entity'])) {
        $element['#type'] = 'container';
        $element['#field_type'] = 'webform_entity_view';
        $view_builder = $this->entityTypeManager->getViewBuilder($entity->getEntityTypeId());
        $element[] = $view_builder->view($entity, $element['#view_mode'], $entity->language()->getId());
